<h1 align="center">ALAMGIR HOSSAIN</h1>
<h3 align="center">MS Student in Computer Science | University of Tennessee, Knoxville</h3>
<h4 align="center">Graduate Research Assistant @ Fluidic City Lab</h4>
...
I'm a Computer Science graduate student at UTK working on **reinforcement learning for humanoid robotics** under [Dr. Weizi Li](https://weizi-li.github.io/) at the Fluidic City Lab. My research focuses on developing intelligent robotic systems that can safely operate in dynamic real-world environments.

**Current Research:**
- 🤖 **Dual-arm manipulation** with Piper robotic arms + TetherIA Aero dexterous hands
- 🚶 **RL-based locomotion policies** for Unitree G1 humanoid robot in construction environments
- 🛡️ **Safe navigation** combining RL with Control Barrier Functions (CBF)

**Background:** B.Sc. in Electrical & Electronic Engineering from BUET (2024), where I developed EEG-based brain-computer interfaces achieving 93% accuracy on inner speech decoding.
...
- **A. Hossain**, S. Liu, W. Li, J. Tan, S. Li. "A Dual-Policy Framework for Safe and Continuous Humanoid Locomotion in Dynamic Construction Environments." *In Preparation.*

- **A. Hossain**, D. Huang, W. Li, J. Tan, S. Li. "Learning Humanoid Locomotion Skills for Material Handling and Transportation in Construction Sites." *Journal of Intelligent Construction* (2025).

- H. Rime, **A. Hossain**, A. Qazi. "Attention-aware Memory Aggregation Network for Hyperspectral Image Classification." *ICCIT* (2022).
